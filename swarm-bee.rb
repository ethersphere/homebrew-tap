...
class SwarmBee < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/ethersphere/bee/releases/download/v1.0.0/bee-darwin-amd64.tar.gz"
      sha256 "e82e0fda677a1fb79e9d2c969a9d5f8ab73db163c88b52814f8bd4c2ab763a14"
    end
  end
