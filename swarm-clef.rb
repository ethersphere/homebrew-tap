...
class SwarmClef < Formula
  ...
  if OS.mac?
    url "https://github.com/ethersphere/bee-clef/releases/download/v0.4.5/bee-clef-darwin-amd64.tar.gz"
    sha256 "649f768c93a63b61a38bb94adf29a3b578dac5a0f8436f7e9b0382901c8176f2"
  end
