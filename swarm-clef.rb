...
class SwarmClef < Formula
  ...
  if OS.mac?
    url "https://github.com/ethersphere/bee-clef/releases/download/v0.4.1/bee-clef-darwin-amd64.tar.gz"
    sha256 "8b51776bcc4d08cdd2ae9ddeaa7e438ee8f8b643d2b2b58fed10c7bf338568a7"
  end
