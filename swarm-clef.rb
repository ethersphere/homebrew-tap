...
class SwarmClef < Formula
  ...
  if OS.mac?
    url "https://github.com/ethersphere/bee-clef/releases/download/v0.4.13/bee-clef-darwin-amd64.tar.gz"
    sha256 "059cc0610e0af774dd364033f73909a19dc9219811f95101f6797ee96a77404c"
  end
