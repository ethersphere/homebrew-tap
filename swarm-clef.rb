...
class SwarmClef < Formula
  ...
  if OS.mac?
    url "https://github.com/ethersphere/bee-clef/releases/download/v0.4.12/bee-clef-darwin-amd64.tar.gz"
    sha256 "7b4842b663b45478003186e1cc6a459ea872512a3f41bcade38e82671d111e7e"
  end
