...
class SwarmClef < Formula
  ...
  if OS.mac?
    url "https://github.com/ethersphere/bee-clef/releases/download/v0.4.10/bee-clef-darwin-amd64.tar.gz"
    sha256 "2ac332e49b00b03e87ef528a9c536d06f9cb568678107425bc6ffada762b0810"
  end
